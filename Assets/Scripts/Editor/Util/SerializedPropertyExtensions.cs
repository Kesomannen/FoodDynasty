...
public static class SerializedPropertyExtension
{
    ...
    private static object GetFieldValueWithIndex(string fieldName, object obj, int index, BindingFlags bindings = BindingFlags.Instance | BindingFlags.Static | BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.DeclaredOnly) {
        object list = GetFieldValue(fieldName, obj, bindings);
    ...
    public static SerializedProperty Find(this SerializedProperty serializedProperty, string propertyPath) {
        return serializedProperty.FindPropertyRelative(propertyPath);
    }
}
